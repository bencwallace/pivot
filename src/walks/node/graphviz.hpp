...
template <class P, int Dim> void walk_node<P, Dim>::todot(const std::string &path) const {
...
template <class P, int Dim> Agnode_t *walk_node<P, Dim>::todot(Agraph_t *g, const cgraph_t &cgraph) const {
